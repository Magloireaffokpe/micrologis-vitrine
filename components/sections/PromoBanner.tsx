      ...
      <div className="max-w-[1280px] mx-auto px-4">
        <div className="flex items-center justify-center flex-wrap">
          {items.map(({ icon: Icon, text }, i) => (
            <div key={text} className={`flex items-center gap-2 text-white/75 text-[12px] font-medium px-3 sm:px-5 py-2.5 hover:text-white transition-colors ${i > 0 ? 'border-l border-white/10' : ''}`}>
